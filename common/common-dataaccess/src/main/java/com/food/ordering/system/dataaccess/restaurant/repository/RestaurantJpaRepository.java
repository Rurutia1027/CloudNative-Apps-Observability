...
@Repository
public interface RestaurantJpaRepository extends JpaRepository<RestaurantEntity,
        RestaurantEntityId> {
    /**
     ...
     */
    List<RestaurantEntity> findByRestaurantIdAndProductIdIn(UUID restaurantId,
