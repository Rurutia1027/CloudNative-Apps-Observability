...
public class KafkaMessageHelper {
    ...
    getKafkaCallback(String responseTopicName, T avroModel, U outboxMessage,
        ...
        return new ListenableFutureCallback<SendResult<String, T>>() {
            ...
            public void onFailure(Throwable ex) {
                log.error("Error while sending {} with message: {} and outbox type: {} to " +
                                "topic: {}",
                        avroModelName, avroModel.toString(),
    ...
    public <T> T getOrderEventPayload(String payload, Class<T> outputType) {
        try {
            ...
            log.error("Could not read {} OrderPaymentEventPayload object!", outputType.getName(), e);
            throw new OrderDomainException("Could not read " + outputType.getName() +
                    "OrderPaymentEventPayload object!", e);
        }
    }
}