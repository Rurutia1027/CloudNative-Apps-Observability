...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    // TODO: explain this kafka listener inner exception handle strategy in detail
    @Override
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        log.info("{} number of payment requests received with keys: {}, partitions: {} and " +
                        "offsets: {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
        ...
        messages.forEach(paymentRequestAvroModel -> {
            try {
                ...
                if (sqlException != null && sqlException.getSQLState() != null
                    ...
                    throw new PaymentApplicationServiceException("Throwing " +
                            "DataAccessException in PaymentRequestKafkaListener: " + e.getMessage(), e);
                }
