...
public class OrderOutboxHelper {
    ...
    @Transactional(readOnly = true)
    public Optional<List<OrderOutboxMessage>>
    getOrderOutboxMessageByOutboxStatus(OutboxStatus outboxStatus) {
    ...
    @Transactional
    public void updateOutboxMessage(OrderOutboxMessage orderOutboxMessage,
                                    OutboxStatus outboxStatus) {
    ...
    private String createPayload(OrderEventPayload orderEventPayload) {
        try {
            ...
            throw new PaymentDomainException("Cloud not create OrderEventPayload json!", e);
        }
    }
