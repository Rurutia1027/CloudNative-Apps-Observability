...
public class ApprovalOutboxRepositoryImpl implements ApprovalOutboxRepository {
    ...
    // save outbox msg of order-approval to db
    @Override
        ...
        return approvalOutboxDataAccessMapper
                .approvalOutboxEntityToOrderApprovalOutboxMessage(approvalOutboxJpaRepository
                        .save(approvalOutboxDataAccessMapper
                                .orderCreateOutboxMessageToOutboxEntity(orderApprovalOutboxMessage)));
    }
    ...
    findByTypeAndOutboxStatusAndSagaStatus(String sagaType,
        ...
        return Optional.of(approvalOutboxJpaRepository.findByTypeAndOutboxStatusAndSagaStatusIn(
                ...
                .orElseThrow(() -> new ApprovalOutboxNotFoundException("Approval outbox " +
                        "object could be found for saga type " + sagaType))
                .stream()
    ...
    findByTypeAndSagaIdAndSagaStatus(String sagaType,
        ...
        return approvalOutboxJpaRepository
                .findByTypeAndSagaIdAndSagaStatusIn(sagaType,
                        sagaId,
    ...
    public void deleteByTypeAndOutboxStatusAndSagaStatus(String sagaType,
                                                         OutboxStatus outboxStatus,
                                                         SagaStatus... sagaStatus) {
        approvalOutboxJpaRepository.deleteByTypeAndOutboxStatusAndSagaStatusIn(sagaType,
                outboxStatus,
                Arrays.asList(sagaStatus));
    }
}
