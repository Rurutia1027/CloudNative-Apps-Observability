...
public class PaymentOutboxDataAccessMapper {
    ...
    public OrderPaymentOutboxMessage paymentOutboxMessageToOrderPaymentOutboxMessage(PaymentOutboxEntity
                                                                                             paymentOutboxEntity) {
    ...
    public OrderPaymentOutboxMessage
    paymentOutboxEntityToOrderPaymentOutboxMessage(PaymentOutboxEntity paymentOutboxEntity) {
        return OrderPaymentOutboxMessage.builder()
                .id(paymentOutboxEntity.getId())
                .sagaId(paymentOutboxEntity.getSagaId())
                .createdAt(paymentOutboxEntity.getCreatedAt())
