...
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {
    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        log.info("{} number of restaurant approval responses received with keys {}, " +
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
                    try {
                        if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                            ...
                            restaurantApprovalResponseMessageListener.orderApprove(orderMessagingDataMapper
                        ...
                        log.error("Caught optimistic locking exception in " +
                                        "RestaurantApprovalResponseKafkaListener for order id: {}",
                                restaurantApprovalResponseAvroModel.getOrderId());
                    } catch (OrderNotFoundException e) {
                        // NO-OP for Order NotFoundException
