...
public class PaymentOutboxCleanerScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        ...
        if (outboxMessageResponse.isPresent()) {
            ...
            // TODO: here before we delete all the outbox data records , we can also
            // TODO impl an archive table repository, and move the to be deleted db records
            //  to archive table for future analyzing and audit
