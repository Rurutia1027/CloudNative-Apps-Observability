...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new OrderDomainException("Could not save OrderApprovalOutboxMessage with " +
                    "outbox id: " + orderApprovalOutboxMessage.getId());
        }
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            throw new OrderDomainException("Could not create OrderApprovalEventPayload for " +
                    "order id: " + orderApprovalEventPayload.getOrderId(), e);
        }
    }
}
