...
public class PaymentOutboxHelper {
    ...
    @Transactional(readOnly = true)
    public Optional<OrderPaymentOutboxMessage> getPaymentOutboxMessageByIdAndSagaStatus(UUID sagaId,
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new OrderDomainException("Could not save OrderPaymentOutboxMessage with " +
                    "outbox id: " + orderPaymentOutboxMessage.getId());
        }
