...
public class OrderApplicationServiceTest {
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price: 250.00 is not equal to" +
                " Order items total: 200.00!", orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price: 60.00 is not " +
                "valid for product " + PRODUCT_ID, orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithPassiveRestaurant() {
        ...
        assertEquals(
                "Restaurant with id " + RESTAURANT_ID + " is currently not active!", orderDomainException.getMessage());
    }
}